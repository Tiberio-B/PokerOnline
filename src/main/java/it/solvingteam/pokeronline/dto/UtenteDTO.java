...
public class UtenteDTO {
	...
	public UtenteDTO(String id, String nome, String cognome, String username, String exp, String credito, String[] idRuoli, boolean checkRuoli) {
		this.id = id;
		this.nome = nome;
		this.cognome = cognome;
		this.username = username;
